...
<acme:form>
	<acme:form-textbox code="any.inventor.form.label.identity.fullName" path="identity.fullName"/>
	...
	<acme:form-checkbox code="any.inventor.form.label.licensed" path="licensed"/>
		<acme:form-textbox code="any.inventor.form.label.identity.email" path="identity.email"/>
</acme:form>
