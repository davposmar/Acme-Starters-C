...
<acme:form>
	<acme:form-textbox code="any.sponsor.form.label.identity.fullName" path="identity.fullName"/>
	...
	<acme:form-textbox code="any.sponsor.form.label.identity.email" path="identity.email"/>
</acme:form>
