...
<acme:form>
	<acme:form-textbox code="any.fundraiser.form.label.identity.fullName" path="identity.fullName"/>
	<acme:form-textbox code="any.fundraiser.form.label.identity.email" path="identity.email"/>
